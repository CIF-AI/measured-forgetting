...
\textbf{Aggregation parity:} V2 scores 2.56 vs V1's 2.60 on aggregation --- the only class where V2 does not win. Aggregation data hits a single dimension (data), preventing the super-linear $\Phi$ boost. A class-specific override is the natural fix.
